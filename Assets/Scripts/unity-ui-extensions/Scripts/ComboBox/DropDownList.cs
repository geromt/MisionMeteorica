...
namespace UnityEngine.UI.Extensions
{
    ...
    public class DropDownList : MonoBehaviour
    {
        ...
        public delegate void DropListActions(string idPaciente, string nombrePaciente);
        public static event DropListActions pacienteSeleccionado;
        ...
        //public InterfazMedico scriptInterfazMedico;  <---si va, pero poner como evento
		...
		*/
        ...
        {
            //scriptInterfazMedico.UltimosHijos ();  <-------------SI va, pero ponerlo como evento
            ...
            if (this.name.Equals("SeleccionaRutina_DropDownList"))
            {
                ...
                {
                    //scriptInterfazMedico.ReadRutina (Items [indx].ID.ToString ());   <-------------SI va, pero ponerlo como evento
                    //scriptInterazClinica.ReadRutina (Items [indx].ID.ToString ());
                }
            }

            if (this.name.Equals("SeleccionaPaciente_DropDownList") || this.name.Equals("SeleccionaPacienteR_DropDownList"))
            {
                if (Items[indx].ID.ToString() != " ")
                {
                    if (pacienteSeleccionado != null)
                    {
                        pacienteSeleccionado(Items[indx].ID.ToString(), Items[indx].Caption.ToString()); //envio el ID del paciente y su nombre  <-------------SI va, pero ponerlo como evento
                    }
                    //if (!Application.loadedLevelName.Equals ("AsignaNivel"))
                    //scriptInterfazMedico.RegisterPatientId (Items [indx].ID.ToString(),Items[indx].Caption.ToString()); //envio el ID del paciente y su nombre  <-------------SI va, pero ponerlo como evento
                    //else
