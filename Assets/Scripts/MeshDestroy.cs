...
public class MeshDestroy : MonoBehaviour
{
    ...
    {
        AsteroidController.OnCollideHand += DestroyMesh;
    }
    ...
    private void Awake()
    {
        _asteroidDirection = transform.parent.GetComponent<Rigidbody>().velocity;
    }
    ...
    private void DestroyMesh()
    {
        ...
        for (var c = 0; c < cutCascades; c++)
        {
            for (var i = 0; i < parts.Count; i++)
            {
                ...
                var plane = new Plane(UnityEngine.Random.onUnitSphere, originalMesh.bounds.center);
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            ...
            var randomVector = UnityEngine.Random.onUnitSphere;
            if (Vector3.Angle(-1 * _asteroidDirection, randomVector) > 90)
                randomVector = Vector3.Reflect(randomVector, Vector3.up);
            parts[i].GameObject.GetComponent<Rigidbody>().velocity = UnityEngine.Random.onUnitSphere;
        }
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            GameObject.transform.parent = original.GetComponent<Transform>().parent;
